...
// TinyAPL GitHub raw URLs
const BASE_URL = 'https://raw.githubusercontent.com/RubenVerg/tinyapl/main/docs/pages';
const PRIMITIVES_INDEX_URL = 'https://api.github.com/repos/RubenVerg/tinyapl/contents/docs/pages/primitives';
const GLYPHS_INDEX_URL = 'https://api.github.com/repos/RubenVerg/tinyapl/contents/docs/pages/glyphs';
    ...
    try {
        ...
        for (const file of primitivesList) {
            ...
            try {
                ...
                const docUrl = `https://tinyapl.rubenverg.com/docs/primitive/${fileSlug}`;
                ...
                try {
                    ...
                    if (glyphChar && !glyphDocs[glyphChar]) {
                        ...
                        glyphDocs[glyphChar] = {
                            ...
                            name: name,
                            type: 'syntax',
                            docUrl: `https://tinyapl.rubenverg.com/docs/glyph/${file.name.replace('.mdx', '')}`
                        };
                        glyphFetched++;
                    }
